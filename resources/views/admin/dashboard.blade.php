...
<div class="max-w-7xl mx-auto p-6">
    ...
    {{-- Header --}}
    <div class="mb-8">
        <h1 class="text-4xl font-extrabold text-gray-800">Super Admin Dashboard</h1>
        <p class="text-gray-600 mt-2">Kelola seluruh sistem dengan mudah dan cepat.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
           ...
           class="group bg-gradient-to-br from-blue-600 to-blue-800 text-white p-7 rounded-2xl shadow-xl
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm opacity-90">Manajemen user, dosen, dan admin.</p>
                </div>
           ...
           class="group bg-gradient-to-br from-teal-500 to-teal-700 text-white p-7 rounded-2xl shadow-xl
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm opacity-90">Atur jadwal kuliah & dosen.</p>
                </div>
                <div class="text-5xl opacity-70 group-hover:opacity-100 transition">📆</div>
            </div>
        </a>
           ...
           class="group bg-gradient-to-br from-yellow-400 to-yellow-600 text-gray-900 p-7 rounded-2xl shadow-xl
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm opacity-90">Pantau absensi dosen & mahasiswa.</p>
                </div>
        ...
        <a href="{{ route('admin.bobot.index') }}"
           class="group bg-gradient-to-br from-purple-600 to-purple-800 text-white p-7 rounded-2xl shadow-xl
                  hover:shadow-2xl transform hover:-translate-y-1 transition duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-semibold">Pengaturan Bobot Nilai</h2>
                    <p class="mt-1 text-sm opacity-90">
                        Atur bobot penilaian tiap mata kuliah.
                    </p>
                </div>
                <div class="text-5xl opacity-70 group-hover:opacity-100 transition">⚖️</div>
            </div>
        </a>
           ...
           class="group bg-gradient-to-br from-red-500 to-red-700 text-white p-7 rounded-2xl shadow-xl
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm opacity-90">Rekap keseluruhan data sistem.</p>
                </div>
                <div class="text-5xl opacity-70 group-hover:opacity-100 transition">📊</div>
            </div>
        </a>
        ...
        {{-- Monitoring --}}
        <a href="#"
           class="group bg-gradient-to-br from-gray-700 to-gray-900 text-white p-7 rounded-2xl shadow-xl
                  hover:shadow-2xl transform hover:-translate-y-1 transition duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-semibold">Monitoring</h2>
                    <p class="mt-1 text-sm opacity-90">Cek aktivitas & performa sistem.</p>
                </div>
                <div class="text-5xl opacity-70 group-hover:opacity-100 transition">🖥️</div>
            </div>
        </a>
