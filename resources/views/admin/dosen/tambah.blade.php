...
<div class="max-w-3xl mx-auto bg-white p-6 rounded shadow">  
    <h2 class="text-2xl font-semibold mb-4">Tambah User + Data Dosen/Mahasiswa</h2>  
    ...
    <form action="{{ route('admin.user.store') }}" method="POST" enctype="multipart/form-data">  
        ...
        {{-- ================= USER ================= --}}  
        <h3 class="text-xl font-semibold mt-4 mb-2">Akun User (Untuk Login)</h3>  
        ...
        <div id="form-mahasiswa" class="hidden">
            <h3 class="text-xl font-semibold mb-2">Data Mahasiswa</h3>  
            <div class="grid grid-cols-2 gap-4">
                <div class="mb-3">
                    <label class="font-medium">NIM</label>
                    <input type="text" name="nim" class="w-full border px-3 py-2 rounded">
                </div>
                <div class="mb-3">
                    <label class="font-medium">Nama Mahasiswa</label>
                    <input type="text" name="nama_mahasiswa" class="w-full border px-3 py-2 rounded">
                </div>
                <div class="mb-3">
                    <label class="font-medium">Program Studi</label>
                    <input type="text" name="prodi" class="w-full border px-3 py-2 rounded">
                </div>
                <div class="mb-3">
                    <label class="font-medium">Angkatan</label>
                    <input type="number" name="angkatan" class="w-full border px-3 py-2 rounded">
                </div>
                <div class="mb-3">
                    <label class="font-medium">Email Mahasiswa</label>
                    <input type="email" name="email_mahasiswa" class="w-full border px-3 py-2 rounded">
                </div>
                <div class="mb-3">
                    <label class="font-medium">No. Telepon</label>
                    <input type="text" name="no_telp_mahasiswa" class="w-full border px-3 py-2 rounded">
                </div>
            </div>
        </div>
