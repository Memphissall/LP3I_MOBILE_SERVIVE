...
<div class="p-6 max-w-5xl mx-auto">
    ...
    <p><strong>Durasi:</strong> ({{ $durasiMenit }} Menit)</p>
        ...
        <div class="text-gray-600 mb-6 italic text-sm flex flex-wrap items-center gap-2">
        ...
        <form id="absenForm" action="{{ route('admin.pendidik.absen.store', [$id_kelas, $id_mk]) }}" method="POST">
            ...
            <div class="overflow-x-auto rounded-lg border border-gray-300 mb-6">
                <table class="min-w-full table-auto border-collapse min-w-[650px]">
                    <thead class="bg-gray-100">
                        <tr>
                            <th class="border-b border-gray-300 px-4 py-2 text-left w-48">NIPD</th>
                            <th class="border-b border-gray-300 px-4 py-2 text-left">Nama Mahasiswa</th>
                            <th class="border-b border-gray-300 px-4 py-2 text-center w-64">Status Kehadiran</th>
                        </tr>
                    </thead>
                    <tbody>
        ...
        <label class="inline-flex items-center cursor-pointer">
            ...
            <span class="ml-1 text-xs">Alpha</span>
                ...
                {{-- Tombol Simpan --}}
                <button type="submit"
                    class="bg-indigo-600 text-white px-5 py-2 rounded shadow text-sm font-bold hover:bg-indigo-700 active:scale-95 transition-all">
                    Simpan & Lanjut LKM →
                </button>
            </div>
