        ...
        <form action="{{ route('pendidik.lkm.store', [$id_kelas, $id_mk]) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div>
                    ...
                    <select name="pertemuan" class="block w-full border-gray-300 rounded-md shadow-sm font-bold text-indigo-600 focus:ring-indigo-500">
                        @for ($i = 1; $i <= 14; $i++)
            ...
            <div class="flex justify-end gap-3">
                <a href="{{ url('/pendidik/absensi/list/'.$id_kelas.'/'.$id_mk) }}" class="bg-gray-100 text-gray-600 px-6 py-2.5 rounded font-bold hover:bg-gray-200 transition text-sm">
                    BATAL
                </a>
