...
<div class="p-6">
    <div class="max-w-6xl mx-auto bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
        ...
        {{-- HEADER --}}
        <div class="bg-[#004269] px-6 py-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
            <h2 class="text-lg sm:text-xl font-bold text-white">Daftar Tugas</h2>

            <div class="flex justify-between sm:justify-end items-center gap-2 w-full sm:w-auto">
                <a href="{{ route('tugas.pilih') }}"
                   class="bg-gray-200 text-[#004269] px-3 py-1.5 rounded-lg text-xs font-bold hover:bg-gray-300 transition shadow-sm text-center">
                    ← KEMBALI
                </a>

                <a href="{{ route('tugas.tambah', [$id_kelas, $id_mk]) }}"
                   class="bg-white text-[#009DA5] px-3 py-1.5 rounded-lg text-xs font-bold hover:bg-gray-100 transition shadow-sm text-center">
                    + TAMBAH TUGAS
                </a>
            </div>
        </div>
