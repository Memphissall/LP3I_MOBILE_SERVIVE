            ...
            <div id="header-daftar-dosen" class="p-5 border-b bg-gradient-to-r from-[#004269] to-[#009DA5]">
                <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <h3 class="text-xl font-bold text-white tracking-wide">Daftar Data Pendidik <span
                                class="bg-white/20 px-2 py-0.5 rounded text-sm font-mono ml-2" id="lecturer-count">0</span>
                        </h3>
                    </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th
                                class="px-3 py-3 text-center text-sm font-extrabold text-[#004269] uppercase tracking-wider w-12 border-b-2 border-gray-200 whitespace-nowrap">
                                No</th>
                            <th
                            ...
                            <th
                                ...
                                Email</th>
                            <th
                                class="px-3 py-3 text-center text-sm font-extrabold text-[#004269] uppercase tracking-wider w-28 border-b-2 border-gray-200 whitespace-nowrap">
                                Status</th>
                            <th
                                class="px-3 py-3 text-center text-sm font-extrabold text-[#004269] uppercase tracking-wider w-24 border-b-2 border-gray-200 whitespace-nowrap">
                                Aksi</th>
                        </tr>
                    </thead>
                    <tbody id="lecturer-table-body" class="bg-white divide-y divide-gray-100 text-sm">
                        <tr>
                            {{-- Colspan 11 untuk 11 Kolom --}}
                            <td colspan="11" class="px-6 py-10 text-center text-gray-500 italic">
                                <div class="flex flex-col items-center justify-center">
                                    <span class="text-sm font-medium text-gray-400">Silakan klik tombol "Terapkan Filter"
            ...
            function renderTable() {
                ...
                $.ajax({
                    ...
                    error: function (xhr) {
                        ...
                        console.error(xhr);
                        $tbody.html('<tr><td colspan="11" class="px-6 py-10 text-center text-red-500 italic">Terjadi kesalahan saat memuat data.</td></tr>');
                    },
                    complete: function () {
