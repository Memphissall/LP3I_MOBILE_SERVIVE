{{-- resources/views/akademik/pengumuman/edit.blade.php --}}
...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-2xl font-extrabold text-[#004269] tracking-tight">Edit Pengumuman</h1>
            <p class="text-sm text-gray-500 mt-1">Perbarui informasi pengumuman yang sudah ada.</p>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 overflow-hidden border border-gray-100 max-w-4xl mx-auto">
        ...
        <form action="{{ route('admin.pengumuman.update', $pengumuman->id) }}" method="POST" enctype="multipart/form-data" class="p-8">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div class="group">
                    ...
                    <input type="text" id="judul" name="judul" value="{{ $pengumuman->judul }}" required placeholder="Contoh: Jadwal Libur Semester Ganjil 2025" 
                ...
                <div class="group">
                    ...
                    <textarea id="isi" name="isi" rows="8" required placeholder="Tuliskan detail pengumuman secara lengkap di sini..." 
                        class="w-full p-3.5 text-sm font-medium text-gray-700 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:bg-white focus:border-[#009DA5] focus:ring-4 focus:ring-[#009DA5]/10 transition-all duration-200 placeholder-gray-400 resize-none">{{ $pengumuman->isi }}</textarea>
                ...
                <div class="group">
                    ...
                    <div class="mb-4 p-4 bg-blue-50 border border-blue-100 rounded-xl flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <a href="{{ asset('storage/' . $pengumuman->file_path) }}" target="_blank" class="text-sm font-medium text-blue-600 hover:text-blue-800 hover:underline flex items-center transition-colors">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex-1">
                            <span id="file-name" class="text-sm font-medium text-gray-500 italic block truncate">Tidak ada file baru dipilih</span>
