<x-guest-layout>
    ...
    <div class="min-h-screen flex font-['Poppins']">
        ...
        <div class="hidden lg:flex w-1/2 bg-cover bg-center relative"
            ...
            <div class="relative z-10 flex flex-col justify-center items-center w-full px-10 text-center">
                ...
                <p class="text-gray-700 max-w-md text-lg leading-relaxed">
                    Platform untuk pendidik mengelola data akademik,
                    nilai, dan presensi secara efisien.
                </p>
            </div>
        </div>
        ...
        <div class="flex w-full lg:w-1/2 justify-center items-center 
                    bg-gradient-to-b from-blue-800 to-blue-600 p-6">

            <div class="w-full max-w-md bg-white bg-opacity-10 backdrop-blur-lg 
                        p-10 rounded-3xl shadow-2xl text-white">

                {{-- HEADER (LOGO & TITLE SEJAJAR) --}}
                <div class="mb-10 text-center">

                    <div class="flex items-center justify-center gap-4">
                        <img src="{{ asset('images/logo global.png') }}"
                             alt="Logo Kampus"
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-5">
                        ...
                        <input id="email"
                               ...
                               class="w-full px-4 py-3 rounded-xl bg-white
                                      ...
                                      focus:ring-2 focus:ring-blue-300 border-0">
                    ...
                    <div class="flex items-center mb-6">
                        ...
                        <label for="remember_me"
                               class="ms-2 text-sm text-blue-100">
                            Ingat saya
                        </label>
                    </div>
                    ...
                    {{-- BUTTON --}}
                    <button type="submit"
                        class="w-full bg-gradient-to-r from-blue-500 to-blue-400
                ...
                <div class="mt-8 text-center text-sm text-blue-100">
                    ...
                    <a href="{{ route('register') }}"
                       class="text-white underline font-medium hover:text-blue-200">
                        Daftar di sini
                    </a>
                </div>
