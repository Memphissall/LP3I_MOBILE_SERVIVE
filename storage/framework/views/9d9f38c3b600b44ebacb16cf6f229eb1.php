...
<div class="card">
    ...
    <?php endif; ?>
    <form method="POST" action="<?php echo e(url('/marketing/login')); ?>">
        <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\LP3IKARAWANG\LP3I_MOBILE_SERVIVE\resources\views/marketing/login.blade.php ENDPATH**/ ?>