    ...
    <div class="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-6 items-start">
      ...
      <aside class="bg-white rounded-xl border p-5 shadow-sm sticky top-6">
        ...
        <nav class="space-y-2 text-sm">
          ...
          <a class="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-50 bg-slate-50" href="<?php echo e(route('pendaftar.biodata.show')); ?>">
          ...
          <details class="group details-acc">
            ...
            <div class="pl-4 mt-2 space-y-1">
              <a href="<?php echo e(route('pendaftar.akun.email')); ?>" class="block px-3 py-1 rounded hover:bg-slate-100">Email</a>
              <a href="<?php echo e(route('pendaftar.akun.password')); ?>" class="block px-3 py-1 rounded hover:bg-slate-100">Password</a>
              <a href="<?php echo e(route('pendaftar.akun.phone')); ?>" class="block px-3 py-1 rounded hover:bg-slate-100">No Handphone</a>
              <a href="<?php echo e(route('pendaftar.akun.whatsapp')); ?>" class="block px-3 py-1 rounded hover:bg-slate-100">No Whats App</a>
            </div>
          </details>
        ...
        <div class="bg-white rounded-xl card-adv p-6">
          ...
          <div class="flex gap-6 items-start">
            <div class="w-64">
              <div class="rounded-lg overflow-hidden shadow-sm">
                <div class="w-full h-64 bg-gradient-to-br from-slate-50 to-white flex items-center justify-center">
                  <?php if(!empty($pendaftar->photo_url) || !empty($pendaftar->file_path)): ?>
                    <img src="<?php echo e(asset(ltrim($pendaftar->photo_url ?? $pendaftar->file_path,'/'))); ?>" alt="Foto Profil" class="w-full h-64 object-cover" />
                  <?php else: ?>
              ...
              <a href="<?php echo e(route('pendaftar.biodata.edit')); ?>" class="mt-4 inline-block w-full text-center py-2 rounded-md text-white font-semibold btn-basic">Edit Biodata</a>
            </div>
            ...
            <div class="flex-1">
              <div class="flex items-center justify-between">
                ...
                <div class="text-sm text-slate-500">Nomor: <span class="font-medium text-slate-700"><?php echo e($pendaftar->nipd ?? ($pendaftar->id ?? '-')); ?></span></div>
              </div>
...
<?php /**PATH D:\LP3IKARAWANG\LP3I_MOBILE_SERVIVE\resources\views/pendaftar/biodata.blade.php ENDPATH**/ ?>